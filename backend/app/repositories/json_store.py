...
class JsonStore:
    ...
    def write_all(self, items: list[dict[str, Any]]) -> None:
        ...
        self.path.write_text(json.dumps(cleaned, indent=2, default=str), encoding="utf-8")
...
def save_review_queue(items: list[dict[str, Any]]) -> None:
    ...
    REVIEW_FILE.write_text(json.dumps(repair_mojibake(items), indent=2, default=str), encoding="utf-8")
